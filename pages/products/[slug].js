    ...
    <section class="text-gray-600 body-font overflow-hidden">
      <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://source.unsplash.com/1500x1000/?devices" />
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div class="flex">
              <span class="title-font font-medium text-2xl text-gray-900">$500</span>
              <button class="flex ml-4 text-white bg-indigo-500 border-0 py-2 md:px-6 focus:outline-none hover:bg-indigo-600 rounded"><Link href={"/checkout"}>Buy Now</Link></button>
              <button onClick={addToCart} class="flex ml-2 text-white bg-indigo-500 border-0 py-2 md:px-6 focus:outline-none hover:bg-indigo-600 rounded">Add to cart</button>
